...
master_class_list_button = InlineKeyboardButton('Записать на мастер класс', callback_data='master_class_list')
children_actions_keyboard.add(edit_children_button, children_request_list_button, master_class_list_button)
